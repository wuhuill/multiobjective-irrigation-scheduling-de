function [Yield,theta] = Crop_Yield(IQ,Temp,RN,EP,ET0,start_time,end_time,Tb,PHU,TO,ab1,ab2,LAImax,HUI0,ad,BE,HI,Kc,tiorigin,tiending,Rootorigin,Rootending,thetaorgion,fieldcapacity,wilting)  
%YIELD 计算作物产量
